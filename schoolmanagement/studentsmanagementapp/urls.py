...
from . import hod_views, staff_views, student_views, views, lesson_views, quiz_views
...
urlpatterns = [
    ...
    path('lectureupload', staff_views.lectureupload, name='lectureupload'),
    ...
    #notes
    path('standard_list', lesson_views.StandardListView.as_view(), name='standard_list'),
    path('subject_list', lesson_views.SubjectListView.as_view(), name='subject_list'),
    path('lesson_list', lesson_views.LessonListView.as_view(), name='lesson_list'),
    #path('lesson_create', lesson_views.LessonCreateView.as_view(),name='lesson_create'),
    path('lesson_detail', lesson_views.LessonDetailView.as_view(),name='lesson_detail'),
    path('<str:standard>/<str:subject>/<slug:slug>/update/', lesson_views.LessonUpdateView.as_view(),name='lesson_update'),
    path('<str:standard>/<str:subject>/<slug:slug>/delete/', lesson_views.LessonDeleteView.as_view(),name='lesson_delete'),
 
     #quiz
    path('quiz', quiz_views.quiz, name='quiz'),
    path('addQuestion/<int:code>/<int:quiz_id>', quiz_views.addQuestion, name='addQuestion'),
    path('allQuizzes/<int:code>', quiz_views.allQuizzes, name='allQuizzes'),
    path('quizSummary/<int:code>/<int:quiz_id>', quiz_views.quizSummary, name='quizSummary'),
    path('myQuizzes/<int:code>', quiz_views.myQuizzes, name='myQuizzes'),
    path('startQuiz/<int:code>/<int:quiz_id>', quiz_views.startQuiz, name='startQuiz'),
    path('studentAnswer/<int:code>/<int:quiz_id>', quiz_views.studentAnswer, name='studentAnswer'),
    path('quizResult/<int:code>/<int:quiz_id>', quiz_views.quizResult, name='quizResult'),
